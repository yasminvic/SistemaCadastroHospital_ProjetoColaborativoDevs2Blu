...
{
    public class PacienteRepositorry
    {
        ...
        private Int32 SavePessoa(Paciente paciente, MySqlConnection conn)
        {
            try
            {
                ...
                cmd.Parameters.Add("@tipopessoa", MySqlDbType.VarChar, 25).Value = paciente.Pessoa.TipoPessoa;
                cmd.ExecuteNonQuery();
        ...
        #region SQLS
        private const String SQL_INSERT_PESSOA = @"INSERT INTO pessoa (nome, cgccpf, tipopessoa, flstatus) 
                                                   VALUES (@nome, @cgccpf, @tipopessoa, 'A')";
        ...
        private const String SQL_INSERT_PACIENTE = @"INSERT INTO paciente (id_pessoa, id_convenio, numero_prontuario, paciente_risco, flstatus, flobito) 
                                                     VALUES (@id_pessoa, @id_convenio, @numero_prontuario, @paciente_risco, 'A', 0)";
        private const String SQL_SELECT_PESSOAS = @"SELECT id, nome, cgccpf, tipopessoa, flstatus from pessoa";
        #endregion
    }
}
